...
export default function Page({ searchParams }: PageProps) {
  ...
  return (
    <ArticleLayout meta={meta} section="research" currentSlug="2025/9/an-insiders-view-the-unseen-effects-of-ai-on-youth" refValue={refValue}>
      <article className="lg:col-span-3 text-base leading-7 tracking-normal space-y-5">
                ...
                <p className="font-semibold"><strong>Yes….kindergarten.</strong></p>
                <p className="text-muted-foreground">
                ...
                {/* Q&A Section */}
                <h3 className="pt-4 text-2xl font-semibold tracking-tight">Interview</h3>

                <div className="divide-y divide-border rounded-lg border border-border overflow-hidden">
                  {/* Q1 */}
                  <div className="p-5 space-y-3">
                    <p><span className="font-semibold text-foreground">CMP:</span> Have you observed students using AI tools (e.g., ChatGPT, Khanmigo, Grammarly) in their schoolwork? If so, how often and in what contexts?</p>
                  ...
                  <div className="p-5 space-y-3">
                    ...
                    <p className="mt-1"><span className="font-semibold text-foreground">CMP:</span> So they&apos;re (students) mainly using it as a shortcut?</p>
                    <blockquote className="border-l-4 border-border pl-4 py-1 rounded-md bg-muted/40 italic text-muted-foreground">
                      <p>
                  ...
                  {/* Q3 */}
                  <div className="p-5 space-y-3">
                    <p><span className="font-semibold text-foreground">CMP:</span> Do you think students understand how these tools work?</p>
                    <blockquote className="border-l-4 border-border pl-4 py-1 rounded-md bg-muted/40 italic text-muted-foreground">
                      <p>
                  ...
                  {/* Q4 */}
                  <div className="p-5 space-y-3">
                    <p><span className="font-semibold text-foreground">CMP:</span> Are there specific age groups that seem more inclined to use AI tools than others?</p>
                    <blockquote className="border-l-4 border-border pl-4 py-1 rounded-md bg-muted/40 italic text-muted-foreground">
                      <p>
                  ...
                  <div className="p-5 space-y-3">
                    <h4 className="text-lg font-semibold">How are insecurities on the rise as children use AI?</h4>
                    <p className="text-muted-foreground">
                  ...
                  {/* Q6 */}
                  <div className="p-5 space-y-3">
                    <p><span className="font-semibold text-foreground">CMP:</span> Is there anything you wish parents or administrators better understood about AI and its role in children&apos;s education?</p>
                    <blockquote className="border-l-4 border-border pl-4 py-1 rounded-md bg-muted/40 italic text-muted-foreground">
                      <p>
