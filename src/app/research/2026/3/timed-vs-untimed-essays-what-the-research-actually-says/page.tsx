  ...
  return (
    <ArticleLayout meta={meta} section="research" currentSlug="2026/3/timed-vs-untimed-essays-what-the-research-actually-says" refValue={refValue}>
      <article className="lg:col-span-3 text-base leading-7 tracking-normal space-y-5">
                ...
                <p className="text-muted-foreground">
                  <strong>Test anxiety</strong> affects an estimated 15&ndash;20% of students at high levels (Hill &amp; Wigfield), with broader anxiety prevalence among college students pooled at 31% across a meta-analysis of 13 studies (Chang et al., 2021). A landmark study by Ramirez and Beilock (2011), published in <em>Science</em>, found that highly anxious students who wrote about their fears before tests received an average grade of B+, compared to B&ndash; for those who didn&apos;t, nearly a full grade point improvement. Onwuegbuzie and Seaman (1995) found unlimited time improved performance specifically for students with the highest levels of test anxiety.
                </p>
                <p className="text-muted-foreground">
                ...
                <p className="font-semibold">
                  <strong>The emerging expert consensus recommends a portfolio approach: timed writing for baseline verification and test preparation, untimed writing for developing deep thinking, and process-based monitoring as the bridge that makes both possible without sacrificing either. The question isn&apos;t whether to use timed or untimed essays, it&apos;s how to design a system where both serve their proper pedagogical purpose while keeping the writing authentic.</strong>
                </p>
