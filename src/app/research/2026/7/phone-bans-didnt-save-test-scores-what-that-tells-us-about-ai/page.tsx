...
export const metadata: Metadata = {
  ...
  keywords: [],
  openGraph: {
    images: ["/images/research/phone-bans-didnt-save-test-scores-what-that-tells-us-about-ai/pexels-photo-9780101.jpeg"],
  },
};
...
<li>Beland, L.-P. and Murphy, R. (2013). &quot;Ill Communication: Technology, Distraction &amp; Student Performance.&quot; Centre for Economic Performance, LSE Discussion Paper 1350.</li>
</ol>`;
...
export default function Page({ searchParams }: PageProps) {
  ...
  return (
    <ArticleLayout
      meta={meta}
      section="research"
      currentSlug="2026/7/phone-bans-didnt-save-test-scores-what-that-tells-us-about-ai"
      refValue={refValue}
    >
      <article
