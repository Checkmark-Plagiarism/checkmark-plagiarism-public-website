...
<p>When a student uploads a paper, Moodle hands a copy of that file to the checker through a secure connection, usually along with a little context: which course it belongs to, which assignment, and which student. The checker stores the document, compares it against its sources (web pages, academic databases, and previously submitted student work), runs its AI-writing analysis, and produces a report with a similarity percentage and an AI-likeness signal.</p>
