...
<p>AI detectors are pattern classifiers. They measure how strongly a passage resembles the statistical patterns of machine-generated prose versus human drafting. We call that <em>AI likeness</em>: a real, measurable signal that is also probabilistic. Fluent human writers sometimes pattern like machines; lightly edited AI output sometimes patterns like people. AI likeness correlates with AI use, but it does not prove causation or authorship.</p>
...
<h2>Choice two: AI likeness, not an authorship verdict</h2>
