...
const faqs = [
    {
        question: "Does Canvas have built-in AI or plagiarism detection?",
        answer: "Canvas does not include AI detection or plagiarism checking out of the box. Checkmark adds both directly inside your Canvas workflow, with no extra logins or tab-switching required.",
    },
    {
        question: "How much does Checkmark's Canvas integration cost?",
