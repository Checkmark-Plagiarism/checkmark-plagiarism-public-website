...
const FAQS = [
  ...
  {
    q: "How accurate is Checkmark's AI writing detection?",
    a: "Checkmark is designed to identify AI-writing patterns with high confidence. When grammar, word choice, sentence structure, and rhythm align, AI-generated or AI-assisted writing is the most likely explanation. Review that signal alongside drafting history, paste events, and other context before making a decision.",
  },
  {
