...
export function Nav() {
  ...
  const linkClass = `font-medium transition-smooth ${
      ...
      >
        ...
        <nav className="flex flex-col p-4 gap-1 overflow-y-auto h-[calc(100%-140px)]">
          ...
          <div>
            ...
            {contactExpanded && (
              <div className="ml-4 flex flex-col gap-1">
                ...
                <Link href="/cto" onClick={() => setMobileMenuOpen(false)}
                  className="px-4 py-2 rounded-lg text-sm text-gray-600 hover:bg-brand-50 hover:text-brand-700 transition-smooth">
                  Contact for CTOs
                </Link>
              </div>
          ...
          <div>
            ...
            {supportExpanded && (
              <div className="ml-4 flex flex-col gap-1">
                <Link href="/teacher-support" onClick={() => setMobileMenuOpen(false)}
                  className="px-4 py-2 rounded-lg text-sm text-gray-600 hover:bg-brand-50 hover:text-brand-700 transition-smooth">
                  Teacher Support
                </Link>
                <Link href="/student-support" onClick={() => setMobileMenuOpen(false)}
                  className="px-4 py-2 rounded-lg text-sm text-gray-600 hover:bg-brand-50 hover:text-brand-700 transition-smooth">
                  Student Support
                </Link>
              </div>
