...
<hr class="my-8 border-border" />
""")
# 3. Section 3, Section 4, and Section 5
add("""
...
<hr class="my-8 border-border" />
""")
# 4. Section 6, Section 7, Section 8, Section 9, Section 10, Section 11 and Footer
add("""
...
try:
    ...
    sheet.update_cell(582, 2, "published")
    sheet.update_cell(582, 6, normalized_path)
    print(f"Google Sheet Row 582 successfully updated: Status='published', File Path='{normalized_path}'")
