...
print(f"Written page.tsx successfully to: {target_path}")

# Update Google Sheet Row 580
credentials_path = os.path.join(os.path.dirname(__file__), "credentials.json")
gc = gspread.service_account(filename=credentials_path)
sheet = gc.open("Blog Topic Engine").sheet1

normalized_file_path = target_path.replace("\\\\", "/")
sheet.update_cell(580, 2, "published")
sheet.update_cell(580, 6, normalized_file_path)

print(f"Row 580 updated: Status='published', File Path='{normalized_file_path}'")
