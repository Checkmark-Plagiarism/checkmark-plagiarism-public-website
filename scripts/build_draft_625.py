...
def main():
    target_dir = os.path.join("content", "drafts")
    os.makedirs(target_dir, exist_ok=True)
    target_path = os.path.join(target_dir, "how-can-history-teachers-distinguish-authentic-primary-source-sourcing-from-ai-generated-dbq-synthesis.md")
    ...
    file_rel_path = "content/drafts/how-can-history-teachers-distinguish-authentic-primary-source-sourcing-from-ai-generated-dbq-synthesis.md"

    sheet.update_cell(row_index, 2, "drafted")
    sheet.update_cell(row_index, 5, now_str)
    sheet.update_cell(row_index, 6, file_rel_path)

    updated_row = sheet.row_values(row_index)[:8]
    print(f"Updated row {row_index} in Google Sheets: {updated_row}")
